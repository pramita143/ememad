...
const ComponentsDatatablesAdvanced = () => {
    ...
    return (
        <div className="panel mt-6">
            <h5 className="mb-5 text-lg font-semibold dark:text-white-light">Customer</h5>
            <button type="button" className="btn btn-primary my-5">Add customer</button>            <div className="datatables">
                {isMounted && (
                    <DataTable
